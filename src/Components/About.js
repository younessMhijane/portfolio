      ...
      <div>
        ...
        <div className="download-socialM">
          <div className="socialMedia">
            <a href="https://ma.linkedin.com/in/youness-m-hijane-4ab243261" target="_blank" rel="noopener noreferrer" className="icon-wrapper">
              <img src={linkedin} alt="linkedin" />
              <span className="pulse-ring"></span>
            </a>
            <a href="https://github.com/younessMhijane" target="_blank" rel="noopener noreferrer" className="icon-wrapper">
